...
- 阅读与发现：浏览量、点赞、上一篇/下一篇、作者卡、自动文章/页面目录、可配置版权声明、可配置分享区、复制来源提示、实时搜索 overlay、搜索索引 API、随机封面/特色图 API、Atom feed、sitemap、robots.txt、SEO/Open Graph/Twitter metadata。
