...
- 公开页面：主页、响应式前台导航、文章详情、普通归档 `/archive`、月度归档 `/archives`、搜索、分类、标签、友情链接 `/links`、说说/短动态 `/moments`、独立页面 `/page/{slug}`、404/500 软风格错误页。
...
- 视觉 parity 清单：浮动工具、字体/皮肤控制、移动细节、文章目录、首页文章卡和分类/标签/归档页细节。
...
- 前台登录页。
- 浮动工具、字体/皮肤控制、移动细节和更完整的视觉 parity 修补。
